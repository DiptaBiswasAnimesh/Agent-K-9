...
void introLevelOne()
{
	...
	{
		iShowImage(bullet_x, intro_player.y + jumping_height + 95, 20, 10, bullet_image);
	...
	{
		iShowImage(bullet_back_x, intro_player.y + jumping_height + 95, 20, 10, bullet_back_image);
