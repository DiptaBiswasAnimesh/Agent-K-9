...
void levelOne()
{
	...
	{
		iShowImage(bullet_x, ground_player.y + jumping_height + 95, 20, 10, bullet_image);
	...
	{
		iShowImage(bullet_back_x, ground_player.y + jumping_height + 95, 20, 10, bullet_back_image);
	...
	if (active_shield)
	{
		iShowImage(ground_player.x + 62, ground_player.y + 56 + jumping_height, 40, 47, shield.image);
	}
